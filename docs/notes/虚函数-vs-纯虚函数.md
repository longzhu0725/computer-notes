...
- [多态](/notes/多态.html) - 虚函数是 C++ 多态的基石
- [虚函数实现机制](/notes/虚函数实现机制.html) - vtable/vptr 内存布局
- [继承](/notes/继承.html) - 虚函数在继承中的传递性
- [多重继承与菱形继承](/notes/多重继承与菱形继承.html) - 多个虚函数表
- [如何禁止类被继承](/notes/如何禁止类被继承.html) - final 关键字
- [C++11 新特性](/notes/c++11-新特性.html) - override、final 的引入