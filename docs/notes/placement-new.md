...
- [new vs malloc](./new-vs-malloc.md) — placement new 是 new 家族的特殊成员
- [构造函数](./构造函数.md) — placement new 直接调构造函数
- [智能指针](./智能指针.md) — `make_shared` 内部用 placement new
- [堆 vs 栈](./堆-vs-栈.md) — placement new 跨过普通 new 的分配层
