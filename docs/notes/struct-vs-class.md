...
source: "[raw/2026-06-22_struct-vs-class.md](./raw/2026-06-22_struct-vs-class.md.md)"
source_hash: ee4904eb0852894796ccb9f8c0af0221b5c6345947fe39ceafed2ce4b1590204
domain: cpp
domains:
  - cpp
confidence: medium
...
- 用 `extern "C"` 混编时，**共享的结构体定义要保持 C 兼容**（不加成员函数、不加访问控制、不继承）——见 [cpp/extern C](./cpp/extern-c.md)
...
- [cpp/封装](./cpp/封装.md)：class 的核心价值所在，struct 是"主动放弃封装的 class"
- [cpp/继承](./cpp/继承.md)：struct vs class 的默认继承权限差异正是继承语义的延伸
- [cpp/多态](./cpp/多态.md)：多态必须用 class（或含虚函数的 struct，但惯例是 class）
- [cpp/指针 vs 引用](./cpp/指针-vs-引用.md)：struct 通常按值传递（透明数据），class 通常按 const 引用传递
- [cpp/extern C](./cpp/extern-c.md)：与 C 互操作时，共享的 struct 定义必须保持 C 风格
- [cpp/static vs const](./cpp/static-vs-const.md)：struct 成员默认 public 常和 static/const 配合定义命名常量

## 来源与延伸阅读

- [raw/2026-06-22_struct-vs-class](./raw/2026-06-22_struct-vs-class.md) — 原始资料（卡码笔记 C++ 面试题系列，2026-05-23）
