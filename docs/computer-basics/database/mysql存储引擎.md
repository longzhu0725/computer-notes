...
1. **MySQL 架构概览与存储引擎位置** ，示意图如下：  
	![image](/assets/Architecture_Of_MySQL.jpeg)
2. **四种主流存储引擎的对比** ，如下图所示：  
	![image](/assets/storage_engines_differences.jpeg)
...
- [MySQL B+树索引](/computer-basics/database/mysql-b+树索引.html) — InnoDB索引实现
- [MySQL日志文件](/computer-basics/database/mysql日志文件.html) — 各引擎日志差异
- [事务的四大特性ACID](/computer-basics/database/事务的四大特性acid.html) — InnoDB事务支持

## 来源与延伸阅读

- raw/2026-06-27_mysql-engines.md — 卡码笔记原文
