...
1. **MySQL执行一条SQL查询语句的流程示意图（以MySQL8.0为例）** ，如下所示：  
	![image](/assets/SQL_execution_order.jpeg)
...
- [基本SQL语句](/computer-basics/database/基本sql语句.html) — SQL基础语法
- [MySQL B+树索引](/computer-basics/database/mysql-b+树索引.html) — 索引在执行中的作用
- [MySQL存储引擎](/computer-basics/database/mysql存储引擎.html) — 存储引擎层执行

## 来源与延伸阅读

- raw/2026-06-27_sql-execution.md — 卡码笔记原文
