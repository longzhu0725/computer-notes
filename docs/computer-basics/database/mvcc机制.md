...
1. **MVCC的版本链（Version Chain）示意图如下** ：  
	![image](/assets/mvcc_version_chain.jpeg)
...
- [事务隔离级别](/computer-basics/database/事务隔离级别.html) — MVCC实现的隔离级别
- [事务的四大特性ACID](/computer-basics/database/事务的四大特性acid.html) — 事务基础
- [数据库锁类型](/computer-basics/database/数据库锁类型.html) — MVCC与锁的关系
- [MySQL日志文件](/computer-basics/database/mysql日志文件.html) — undo log版本链

## 来源与延伸阅读

- raw/2026-06-27_mvcc.md — 卡码笔记原文
