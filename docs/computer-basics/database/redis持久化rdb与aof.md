...
2. RDB和AOP持久化示意 ![image](/assets/20260329_Redis_AOF_RDB.jpeg)
...
- [Redis数据结构](/computer-basics/database/redis数据结构.html) — 持久化对象
- [MySQL日志文件](/computer-basics/database/mysql日志文件.html) — 数据库日志与持久化类比
- [Redis主从同步](/computer-basics/database/redis主从同步.html) — 持久化与主从复制

## 来源与延伸阅读

- raw/2026-06-27_redis-persistence.md — 卡码笔记原文
