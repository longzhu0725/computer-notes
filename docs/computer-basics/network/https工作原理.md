...
1. **HTTPS工作原理示意图如下** ：  
	![image](/assets/HTTPS_principle.jpeg)
...
- [HTTPS与HTTP的区别](/computer-basics/network/https与http的区别.html) — 安全传输协议对比
- [HTTP请求头部字段](/computer-basics/network/http请求头部字段.html) — HTTP Headers详解
- [从URL到页面展示](/computer-basics/network/从url到页面展示.html) — Web请求全流程

## 来源与延伸阅读

- raw/2026-06-27_https-encryption.md — 卡码笔记原文
