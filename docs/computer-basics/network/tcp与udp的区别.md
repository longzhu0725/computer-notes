...
1. **TCP 和 UDP 的连接机制对比** ，如下图所示：  
	![image](/assets/TCP_UDP_connection_difference.jpeg)
2. **TCP 和 UDP 通信机制对比** ，如下图所示：  
	![image](/assets/TCP_UDP_transmission_mechanisms.jpeg)
3. **TCP 和 UDP 应用层报文处理对比** ，如下图所示：  
	![image](/assets/TCP_UDP_message_handling.jpeg)
...
- raw/2026-06-27_tcp-vs-udp.md — 卡码笔记原文
