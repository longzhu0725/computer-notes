...
1. **TCP 序列号确认机制** ，如下图所示：  
	![image](/assets/TCP_ack_mechanism.jpeg)
2. **TCP 超时重传机制** ，如下图所示：  
	![image](/assets/TCP_timeout_retransmission.jpeg)
3. **TCP 可靠传输、流量控制与拥塞控制的关系：**
...
- [TCP拥塞控制](/computer-basics/network/tcp拥塞控制.html) — 拥塞控制算法
- [TCP与UDP的区别](/computer-basics/network/tcp与udp的区别.html) — 传输层协议对比

## 来源与延伸阅读

- raw/2026-06-27_tcp-reliability.md — 卡码笔记原文
