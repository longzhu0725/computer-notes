...
1. **TCP四次挥手的示意图如下** ：  
	![image](/assets/TCP_connection_four_termination.jpeg)
2. **TCP三次握手的示意图如下** ：  
	![image](/assets/TCP_connection_three_handshake.jpeg)
...
- [TIME_WAIT状态](/computer-basics/network/time_wait状态.html) — 2MSL等待机制
- [TCP连接可靠性](/computer-basics/network/tcp连接可靠性.html) — TCP可靠传输机制

## 来源与延伸阅读

- raw/2026-06-27_tcp-four-way-handshake.md — 卡码笔记原文
