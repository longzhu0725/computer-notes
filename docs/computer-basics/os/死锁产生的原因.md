...
![image](/assets/deadlock-causes.png)
...
- [死锁与避免](/computer-basics/os/死锁与避免.html) — 死锁概述与避免策略
- [银行家算法](/computer-basics/os/银行家算法.html) — 死锁避免经典算法

## 来源与延伸阅读

- raw/2026-06-27_deadlock-causes.md — 卡码笔记原文
