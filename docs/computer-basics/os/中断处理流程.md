...
← [什么是中断和异常，它们有什么区别？](https://notes.kamacoder.com/base/interrupts-vs-exceptions.html) [你知道的线程的同步方式有哪些？](https://notes.kamacoder.com/base/thread-synchronization.html) →


## 与其他知识的关联

- [中断与异常](/computer-basics/os/中断与异常.html) — 中断与异常概述
- [中断和异常的区别](/computer-basics/os/中断和异常的区别.html) — 中断与异常对比

## 来源与延伸阅读

- raw/2026-06-27_interrupt-handling.md — 卡码笔记原文
