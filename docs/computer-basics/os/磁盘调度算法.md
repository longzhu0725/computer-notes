...
工作方式： 磁头 **从一端开始向另一端移动** ， 途中服务所有请求， **到达另一端后反向移动** ， 重复此过程

特点： **无饥饿问题，公平性好** 平均寻道距离 **介于FCFS和SSTF之间** **边缘请求等待时间较长** （磁头必须到尽头）
...
特点： **等待时间更均匀** ， 对边缘 **请求更公平** （不会长时间等待）， 牺牲一定性能换取公平性

5. N步扫描算法（N-Step-SCAN）
...
![image](/assets/disk-scheduling-algorithms.png)
...
- [进程调度算法](/computer-basics/os/进程调度算法.html) — CPU调度算法
- [设备管理功能](/computer-basics/os/设备管理功能.html) — 设备管理概述

## 来源与延伸阅读

- raw/2026-06-27_disk-scheduling.md — 卡码笔记原文
