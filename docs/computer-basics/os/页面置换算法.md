...
- As the following picture:  
	![image](/assets/page_replacement_algorithms.jpeg)
...
← [什么是内存分段和分页？作用是什么？](https://notes.kamacoder.com/base/memory-segmentation-paging.html) [虚拟内存的作用及页面置换算法？](https://notes.kamacoder.com/base/virtual-memory-page-replacement.html) →


## 与其他知识的关联

- [虚拟内存](/computer-basics/os/虚拟内存.html) — 虚拟内存概念
- [虚拟内存与页面置换](/computer-basics/os/虚拟内存与页面置换.html) — 虚拟内存与页面置换关系
- [内存分段和分页](/computer-basics/os/内存分段和分页.html) — 分页机制

## 来源与延伸阅读

- raw/2026-06-27_page-replacement.md — 卡码笔记原文
