...
- [用户态和内核态](/computer-basics/os/用户态和内核态.html) — 用户态与内核态详解
- [中断与异常](/computer-basics/os/中断与异常.html) — 中断异常机制

## 来源与延伸阅读

- raw/2026-06-27_processor-states.md — 卡码笔记原文
